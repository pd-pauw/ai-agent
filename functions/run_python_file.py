...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description= "run a specified python file relative to the working directory, optionally providing arguments",
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                ...
                description="An array of optional args for running the python file",
                items= types.Schema(
                    type=types.Type.STRING
                )
            )
